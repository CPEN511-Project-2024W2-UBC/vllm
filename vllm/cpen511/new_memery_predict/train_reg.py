...
from model import LstmMemoryPredict, MlpMemoryPredict
...
with torch.no_grad():
    for inputs, label in test_loader:
        ...
        print(
            f"Output: {outputs.tolist()}, Label: {label.tolist()}, correct: {correct}, total: {total}")
print(
    f"Test Loss: {test_loss / len(test_loader)}, Accuracy: {correct / total}")
result_output
